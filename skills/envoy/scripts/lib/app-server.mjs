...
// Catalyst family layout: the skill root is <catalyst>/skills/envoy, so the
// plugin manifest lives two directories above the upstream location.
const PLUGIN_MANIFEST_URL = new URL("../../../../.claude-plugin/plugin.json", import.meta.url);
const PLUGIN_MANIFEST = JSON.parse(fs.readFileSync(PLUGIN_MANIFEST_URL, "utf8"));

export const BROKER_ENDPOINT_ENV = "ENVOY_COMPANION_APP_SERVER_ENDPOINT";
export const BROKER_BUSY_RPC_CODE = -32001;

/** @type {ClientInfo} */
const DEFAULT_CLIENT_INFO = {
  title: "Catalyst Envoy",
  name: "Claude Code",
