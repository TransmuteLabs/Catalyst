---
read-on:
  - a rescue request is being tightened into a vendor prompt before forwarding
home-of:
  - GPT/Codex prompt composition guidance (upstream gpt-5-4-prompting skill)
---
# GPT-5.4 Prompting

Use this skill when `catalyst:envoy-runner` needs to ask Codex or another GPT-5.4-based workflow for help.
...
Reusable blocks live in [prompt-blocks.md](prompt-blocks.md).
Concrete end-to-end templates live in [codex-prompt-recipes.md](codex-prompt-recipes.md).
Common failure modes to avoid live in [codex-prompt-antipatterns.md](codex-prompt-antipatterns.md).
