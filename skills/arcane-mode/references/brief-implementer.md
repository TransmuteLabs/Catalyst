---
read-on:
  - an implementer brief is being written or dispatched
home-of:
  - the implementer brief template (paths scope, deviation rules, git safety, stop rule, statuses, report self-check)
---
# Implementer brief — template and embedded rules
